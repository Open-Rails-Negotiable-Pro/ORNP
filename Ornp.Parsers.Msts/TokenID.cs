...
namespace Ornp.Parsers.Msts
{
    ...
    public enum TokenID : uint
    {
        ...
        // ORNP specific
        ORNPListName, // ORNP specific for multi-carspawnerlists
        ORNPSoundFileName, // ORNP specific for individual level crossing sounds
        ORNPPantographToggle3,
        ORNPPantographToggle4
    }

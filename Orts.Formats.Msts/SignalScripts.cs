...
namespace Ornp.Formats.Msts
{
    ...
    public class SignalScripts
    {
        ...
        public SignalScripts(string RoutePath, IList<string> ScriptFiles, IDictionary<string, Ornp.Formats.Msts.SignalType> SignalTypes, IList<string> ORSignalTypes, IList<string> ORNormalSubtypes)
        {

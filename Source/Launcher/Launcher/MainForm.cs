...
namespace ORNP
{
    public partial class MainForm : Form
    {
        ...
        List<Menu.Activity> Activities = new List<Menu.Activity>();
        ...
        Task<List<Menu.Activity>> ActivityLoader;
        ...
        // Activity mode items
        public Menu.Activity SelectedActivity { get { return (Menu.Activity)comboBoxActivity.SelectedItem; } }
        ...
        void LoadActivityList()
        {
            ...
            ActivityLoader = new Task<List<Menu.Activity>>(this, () => Menu.Activity.GetActivities(selectedFolder, selectedRoute).OrderBy(a => a.ToString()).ToList(), (activities) =>
            {
        ...
        void ShowActivityList()
        {
            ...
            UpdateFromMenuSelection<Menu.Activity>(comboBoxActivity, UserSettings.Menu_SelectionIndex.Activity, a => a.FilePath);
            UpdateEnabled();
        }
        ...
        void UpdateExploreActivity()
        {
            ...
            exploreActivity.Season = (Ornp.Formats.Msts.SeasonType)SelectedStartSeason;
            exploreActivity.Weather = (Ornp.Formats.Msts.WeatherType)SelectedStartWeather;
        }
        #endregion

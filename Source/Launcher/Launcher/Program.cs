            ...
            using (var MainForm = new MainForm())
            {
                while (MainForm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    switch (MainForm.SelectedAction)
                    {
                        ...
                        case MainForm.UserAction.MultiplayerClient:
                        case MainForm.UserAction.MultiplayerServer:
                            if (MainForm.SelectedActivity is ORNP.Menu.DefaultExploreActivity)
                            {
                                var exploreActivity = MainForm.SelectedActivity as ORNP.Menu.DefaultExploreActivity;
                            ...
                            else if (MainForm.SelectedActivity is ORNP.Menu.ExploreThroughActivity)
                            {
                                var exploreActivity = MainForm.SelectedActivity as ORNP.Menu.ExploreThroughActivity;

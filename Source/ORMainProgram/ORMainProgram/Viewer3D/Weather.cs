...
using Ornp.Formats.OR;
using Ornp.MultiPlayer;
using Ornp.Simulation;
using ORNP.Common;
using ORNP.Common.Input;
using Events = Ornp.Common.Events;

namespace Ornp.Viewer3D
{
    public class WeatherControl
    {
        ...
        public WeatherControl(Viewer viewer)
        {
            ...
            ClearSound = new List<SoundSourceBase>() {
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "clear_in.sms"), false),
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "clear_ex.sms"), false),
            };
            RainSound = new List<SoundSourceBase>() {
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "rain_in.sms"), false),
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "rain_ex.sms"), false),
            };
            SnowSound = new List<SoundSourceBase>() {
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "snow_in.sms"), false),
                new SoundSource(viewer, Events.Source.MSTSInGame, ORNPPaths.GetFileFromFolders(pathArray, "snow_ex.sms"), false),
            };
        ...
        public void SetInitialWeatherParameters()
        {
            ...
            {
                case Ornp.Formats.Msts.WeatherType.Clear: Weather.OvercastFactor = 0.05f; Weather.FogDistance = 20000; break;
                case Ornp.Formats.Msts.WeatherType.Rain: Weather.OvercastFactor = 0.7f; Weather.FogDistance = 1000; break;
                case Ornp.Formats.Msts.WeatherType.Snow: Weather.OvercastFactor = 0.6f; Weather.FogDistance = 500; break;
            }
        }
        ...
        public void UpdateWeatherParameters()
        {
            ...
            switch (Viewer.Simulator.WeatherType)
            {
                case Ornp.Formats.Msts.WeatherType.Clear: Weather.PrecipitationLiquidity = 1; Weather.PricipitationIntensityPPSPM2 = 0; Viewer.SoundProcess.AddSoundSources(this, ClearSound); break;
                case Ornp.Formats.Msts.WeatherType.Rain: Weather.PrecipitationLiquidity = 1; Weather.PricipitationIntensityPPSPM2 = 0.010f; Viewer.SoundProcess.AddSoundSources(this, RainSound); break;
                case Ornp.Formats.Msts.WeatherType.Snow: Weather.PrecipitationLiquidity = 0; Weather.PricipitationIntensityPPSPM2 = 0.0050f; Viewer.SoundProcess.AddSoundSources(this, SnowSound); break;
            }
        ...
        void UpdateSoundSources()
        {
            ...
            switch (Viewer.Simulator.WeatherType)
            {
                case Ornp.Formats.Msts.WeatherType.Clear: Viewer.SoundProcess.AddSoundSources(this, ClearSound); break;
                case Ornp.Formats.Msts.WeatherType.Rain: Viewer.SoundProcess.AddSoundSources(this, RainSound); break;
                case Ornp.Formats.Msts.WeatherType.Snow: Viewer.SoundProcess.AddSoundSources(this, SnowSound); break;
            }
        }
        ...
        private bool RandomizeInitialWeather()
        {
            ...
            Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Clear;
            ...
            if (Weather.OvercastFactor > 0.5)
            {
                ...
                if (randValue > 40)
                {
                    ...
                    {
                        Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Snow;
                        Weather.PrecipitationLiquidity = 0;
                    }
                    else
                    {
                        Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Rain;
        ...
        private void CheckDesertZone()
        {
            ...
            new Ornp.Common.WorldLatLon().ConvertWTC(location.TileX, location.TileZ, location.Location, ref latitude, ref longitude);
        ...
        public virtual void Update(ElapsedTime elapsedTime)
        {
            ...
            if (MPManager.IsClient() && manager.weatherChanged)
            {
                ...
                {
                    Viewer.Simulator.WeatherType = (Ornp.Formats.Msts.WeatherType)manager.weather;
                    UpdateWeatherParameters();
                }
            ...
            else if (!MPManager.IsClient())
            {
                ...
                if (UserInput.IsPressed(UserCommand.DebugWeatherChange))
                {
                    switch (Viewer.Simulator.WeatherType)
                    {
                        case Ornp.Formats.Msts.WeatherType.Clear:
                            Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Rain;
                            break;
                        case Ornp.Formats.Msts.WeatherType.Rain:
                            Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Snow;
                            break;
                        case Ornp.Formats.Msts.WeatherType.Snow:
                            Viewer.Simulator.WeatherType = Ornp.Formats.Msts.WeatherType.Clear;
                            break;
                    }
            ...
            if (!Ornp.MultiPlayer.MPManager.IsMultiPlayer())
            {
            ...
            if (Program.Simulator != null && Program.Simulator.ActivityRun != null && Program.Simulator.ActivityRun.triggeredEventWrapper != null &&
               (Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.ORNPWeatherChange != null || Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes.ORNPWeatherChange != null))
                // Start a weather change sequence in activity mode
            {
                ...
                var weatherChange = Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.ORNPWeatherChange ?? Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes.ORNPWeatherChange;
        ...
        public class DynamicWeather
        {
            ...
            public void WeatherChange_Init(ORNPWeatherChange eventWeatherChange, WeatherControl weatherControl)
            {
                var wChangeOn = false;
    ...
    public class AutomaticWeather : WeatherControl
    {
        ...
        public Ornp.Formats.Msts.WeatherType AWPrecipitationActiveType;  // actual active precipitation
        ...
        // precipitation
        public Ornp.Formats.Msts.WeatherType AWPrecipitationRequiredType;// actual active precipitation

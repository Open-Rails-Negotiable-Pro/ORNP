...
using System.Linq;
using static Ornp.Simulation.Physics.Train.TrainObjectItem;

namespace Ornp.Viewer3D.WebServices
{
    /// <summary>
    ...
    public static class TrackMonitorDisplay
    {
        ...
        private static int ItemLocationToRow(int zeroPoint, int itemLocation)
        {
            ...
            switch (zeroPoint)
            {
                ...
                case 132:// lower zone
                    return Ornp.MultiPlayer.MPManager.IsMultiPlayer() ? Round(MathHelper.Clamp(itemLocation * (16.0f / 266.0f), 9, 16))// MultiPlayer mode

...
namespace Ornp.Viewer3D
{
    public class PrecipitationViewer
    {
        ...
        {
            IndexesAre32bit = viewer.Settings.IsDirectXFeatureLevelIncluded(ORNP.Settings.UserSettings.DirectXFeature.Level10_0);
        ...
        public void Reset()
        {
            ...
            Wind.X = Viewer.Simulator.WeatherType == Ornp.Formats.Msts.WeatherType.Snow ? Viewer.Random.Next(2, 6) : Viewer.Random.Next(15, 21);
    ...
    public class PrecipitationPrimitive : RenderPrimitive
    {
        ...
        public void Initialize(Ornp.Formats.Msts.WeatherType weather, Vector3 wind)
        {
            ParticleDuration = ParticleBoxHeightM / (weather == Ornp.Formats.Msts.WeatherType.Snow ? SnowVelocityMpS : RainVelocityMpS) / ParticleVelocityFactor;
    ...
    public class PrecipitationMaterial : Material
    {
        ...
        public override void SetState(GraphicsDevice graphicsDevice, Material previousMaterial)
        {
            ...
            {
                shader.precipitation_Tex.SetValue(Viewer.Simulator.WeatherType == Ornp.Formats.Msts.WeatherType.Snow ? SnowTexture :
                    Viewer.Simulator.WeatherType == Ornp.Formats.Msts.WeatherType.Rain ? RainTexture :

...
using Ornp.Processes;
using ORNP.Common;
using System;
using System.Diagnostics;
using System.Threading;
using CancellationToken = ORNP.Common.CancellationToken;
using CancellationTokenSource = ORNP.Common.CancellationTokenSource;

namespace Ornp.Viewer3D.Processes
{
    public class LoaderProcess
    {
        ...
        readonly ORNP.Common.CancellationTokenSource CancellationTokenSource;
        ...
        public LoaderProcess(Game game)
        {
            ...
            CancellationTokenSource = new ORNP.Common.CancellationTokenSource(WatchdogToken.Ping);
        }
        ...
        /// </para>
        /// </remarks>
        public ORNP.Common.CancellationToken CancellationToken
        {
            get
            {

    ...
    public class TrackMonitor : Control
    {
        ...
        void drawTrack(SpriteBatch spriteBatch, Point offset, float speedMpS, float allowedSpeedMpS)
        {
            ...
            if (trackColor == Color.Red && !istrackColorRed)//Debrief Eval
            {
                ...
                DbfEvalIniOverSpeedTimeS = Ornp.MultiPlayer.MPManager.Simulator.ClockTime;
            }            
            ...
            if (istrackColorRed && (Ornp.MultiPlayer.MPManager.Simulator.ClockTime - DbfEvalIniOverSpeedTimeS) > 1.0000)//Debrief Eval
            {
                DbfEvalOverSpeedTimeS = DbfEvalOverSpeedTimeS + (Ornp.MultiPlayer.MPManager.Simulator.ClockTime - DbfEvalIniOverSpeedTimeS);

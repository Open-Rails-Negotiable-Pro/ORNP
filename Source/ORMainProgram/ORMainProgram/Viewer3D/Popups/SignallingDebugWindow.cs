...
namespace Ornp.Viewer3D.Popups
{
    ...
    {
        protected static Vector3 Normalize(WorldLocation location, Ornp.Viewer3D.Camera camera)
        {
        ...
        protected static Vector3 Project3D(Vector3 position, Viewport viewport, Ornp.Viewer3D.Camera camera)
        {
        ...
        public abstract void PrepareFrame(List<Rectangle> labels, Viewport viewport, Ornp.Viewer3D.Camera camera);
    ...
    public class DispatcherLineSegment : DispatcherPrimitive
    {
        ...
        public override void PrepareFrame(List<Rectangle> labels, Viewport viewport, Ornp.Viewer3D.Camera camera)
        {

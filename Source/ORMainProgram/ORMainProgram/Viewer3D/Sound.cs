...
namespace Ornp.Viewer3D
{
    ...
    public class TrackSoundSource : SoundSourceBase
    {
        ...
        public TrackSoundSource(MSTSWagon car, Viewer viewer)
        {
            ...
            foreach (Ornp.Formats.Msts.TrackTypesFile.TrackType ttdf in viewer.TrackTypes)
            {
        ...
        private void LoadTrackSound(string filename, bool isInside)
        {
            ...
            var fullPath = ORNPPaths.GetFileFromFolders(pathArray, @"SOUND\" + filename);
            if (fullPath == null)
            {
...
//                Car.Train.Cars.IndexOf(Car), CarOnSwitch, Car.TrackSoundType, _curTType, Viewer.Simulator.GameTime, Car.Train.Name, CarOnCurve, Car.CurrentCurveRadius);
    ...
    public class SoundSource : SoundSourceBase
    {
        ...
        /// <param name="car"></param>
        /// <param name="smsFilePath"></param>
        public SoundSource(Viewer viewer, MSTSWagon car, string wavFilePath, ORNPActSoundFileTypes ORNPActSoundFileType,  bool preCompiled)
        {
            Car = car;
            Initialize(viewer, car.WorldPosition.WorldLocation, Events.Source.MSTSCar, wavFilePath, ORNPActSoundFileType, preCompiled);
        }
        ...
        /// <param name="eventSource"></param>
        /// <param name="smsFilePath"></param>
        public SoundSource(Viewer viewer, Events.Source eventSource, string wavFilePath, ORNPActSoundFileTypes ORNPActSoundFileType, bool isUnattenuated, bool preCompiled)
        {
            IsUnattenuated = isUnattenuated;
            Initialize(viewer, WorldLocation.None, eventSource, wavFilePath, ORNPActSoundFileType, preCompiled);
        }
        ...
        /// <param name="smsFilePath"></param>
        /// <param name="slowRolloff"></param>
        public SoundSource(Viewer viewer, WorldLocation worldLocation, Events.Source eventSource, string wavFilePath, bool slowRolloff, ORNPActSoundFileTypes ORNPActSoundFileType, bool preCompiled)
        {
            IsEnvSound = true;
            SlowRolloff = slowRolloff;
            Initialize(viewer, worldLocation, eventSource, wavFilePath, ORNPActSoundFileType, preCompiled);
        }
        ...
        public bool Active;
        private Ornp.Formats.Msts.Activation ActivationConditions;
        private Ornp.Formats.Msts.Deactivation DeactivationConditions;
        ...
        public void Initialize(Viewer viewer, WorldLocation worldLocation, Events.Source eventSource, string smsFilePath)
        {
            ...
            Ornp.Formats.Msts.SoundManagmentFile smsFile = Ornp.Formats.Msts.SharedSMSFileManager.Get(smsFilePath);
            ...
            {
                Ornp.Formats.Msts.ScalabiltyGroup mstsScalabiltyGroup = smsFile.Tr_SMS.ScalabiltyGroups[iSG];
                ...
                foreach (Ornp.Formats.Msts.SMSStream mstsStream in mstsScalabiltyGroup.Streams)
                {
        ...
        /// <param name="smsFilePath">Full path for sms file</param>
        public void Initialize(Viewer viewer, WorldLocation worldLocation, Events.Source eventSource, string wavFilePath, ORNPActSoundFileTypes ORTSActSoundFileType, bool preCompiled)
        {
            Viewer = viewer;
            WorldLocation = worldLocation;
            ...
            if (Viewer.Settings.SoundDetailLevel >= 3)
            {
                ...
                ActivationConditions = new Ornp.Formats.Msts.Activation();
                DeactivationConditions = new Ornp.Formats.Msts.Deactivation();
                ...
                {
                    case ORNPActSoundFileTypes.Everywhere:
                        ...
                        break;
                    default:
                    case ORNPActSoundFileTypes.Cab:
                        ActivationConditions.CabCam = true;
                        ...
                        IsExternal = false;
                        break;
                    case ORNPActSoundFileTypes.Pass:
                        ...
                        IsExternal = false;
                        break;
                    case ORNPActSoundFileTypes.Ground:
                        ActivationConditions.CabCam = true;
                        ActivationConditions.ExternalCam = true;
                        ActivationConditions.PassengerCam = true;
                        DeactivationConditions.CabCam = false;
                        ...
                        IsExternal = true;
                        break;
                    case ORNPActSoundFileTypes.Location:
                        ActivationConditions.CabCam = true;
                        ActivationConditions.ExternalCam = true;
                        ActivationConditions.PassengerCam = true;
                        DeactivationConditions.CabCam = false;
        ...
        public void HandleEvent(Event eventID)
        {
            foreach (var ss in SoundStreams)
            {
                ...
                {
                    var dt = trg as ORNPDiscreteTrigger;
                    if (dt != null)
            ...
            else
            {
                if (WasOutOfDistance)
                {
                    ...
                    foreach (SoundStream stream in SoundStreams)
                    {
                        ...
                        foreach (ORNPTrigger trigger in stream.Triggers)
                        {
                            trigger.Initialize();
                            trigger.TryTrigger();

                            released |= trigger.Signaled &&
                                (trigger.SoundCommand is ORNPReleaseLoopRelease || trigger.SoundCommand is ORNPReleaseLoopReleaseWithJump);
                            if (trigger is ORNPDiscreteTrigger) trigger.Signaled = false;
                        }
                        ...
                        if (!released && !stream.ALSoundSource.isPlaying)
                        {
                            foreach (ORNPTrigger trigger in stream.Triggers)
                            {
                                if (trigger.Signaled && trigger.Enabled && (trigger.SoundCommand is ORNPStartLoop || trigger.SoundCommand is ORNPStartLoopRelease))
        ...
        /// <returns></returns>
        private bool ConditionsMet(Ornp.Formats.Msts.Activation conditions)
        {
            if (conditions == null)
                return false;
...
/////////////////////////////////////////////////////////
    ...
    public class SoundStream : IDisposable
    {
        ...
        /// </summary>
        public List<ORNPTrigger> Triggers = new List<ORNPTrigger>();
        /// <summary>
        ...
        /// </summary>
        protected Ornp.Formats.Msts.SMSStream MSTSStream;
        /// <summary>
        ...
        /// </summary>
        private ORNPInitialTrigger _InitialTrigger;
        /// <summary>
        ...
        /// </summary>
        public ORNPTrigger LastTriggered = new ORNPTrigger();
        /// <summary>
        ...
        /// </summary>
        public List<ORNPTrigger> VariableTriggers = new List<ORNPTrigger>();
        /// <summary>
        /// Helper object for determining if initial trigger is to be audible
        /// </summary>
        IEnumerable<ORNPTrigger> TriggersList;

        public SoundStream(Ornp.Formats.Msts.SMSStream mstsStream, Events.Source eventSource, SoundSource soundSource, UserSettings settings)
        {
            ...
            if (mstsStream.Triggers != null)
                foreach (Ornp.Formats.Msts.Trigger trigger in mstsStream.Triggers)
                {
                    if (trigger.SoundCommand == null) // ignore improperly formed SMS files
                    {
                        Triggers.Add(new ORNPTrigger()); // null trigger
                    }
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Dist_Travelled_Trigger) && soundSource.Car != null)
                    {
                        Triggers.Add(new ORNPDistanceTravelledTrigger(this, (Ornp.Formats.Msts.Dist_Travelled_Trigger)trigger));
                    }
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Initial_Trigger))
                    {
                        _InitialTrigger = new ORNPInitialTrigger(this, (Ornp.Formats.Msts.Initial_Trigger)trigger);
                        Triggers.Add(_InitialTrigger);
                    }
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Random_Trigger))
                    {
                        Triggers.Add(new ORNPRandomTrigger(this, (Ornp.Formats.Msts.Random_Trigger)trigger));
                    }
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Variable_Trigger) && (soundSource.Car != null || soundSource.IsEnvSound))
                    {
                        Triggers.Add(new ORNPVariableTrigger(this, (Ornp.Formats.Msts.Variable_Trigger)trigger));
                    }
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Discrete_Trigger) && soundSource.Car != null)
                    {
                        ORNPDiscreteTrigger ortsTrigger = new ORNPDiscreteTrigger(this, eventSource, (Ornp.Formats.Msts.Discrete_Trigger)trigger, settings);
                    ...
                    else if (trigger.GetType() == typeof(Ornp.Formats.Msts.Discrete_Trigger))
                    {
                        ORNPDiscreteTrigger ortsTrigger = new ORNPDiscreteTrigger(this, eventSource, (Ornp.Formats.Msts.Discrete_Trigger)trigger, settings);
                        Triggers.Add(ortsTrigger);  // list them here so we can enable and disable 
                    }
                    ...
                    IsReleasedWithJump |= (Triggers.Last().SoundCommand is ORNPReleaseLoopReleaseWithJump);
                }  // for each mstsStream.Trigger

            VariableTriggers = (from t in Triggers 
                                where t is ORNPVariableTrigger
                                select t).ToList();
        }
        ...
        public SoundStream(string wavFileName, Events.Source eventSource, SoundSource soundSource)
        {
            ...
            _InitialTrigger = new ORNPInitialTrigger(this, wavFileName);
            Triggers.Add(_InitialTrigger);
        ...
        public SoundStream(SoundSource soundSource, Func<SoundStream, IEnumerable<ORNPTrigger>> makeTriggers)
        {
            SoundSource = soundSource;
            Volume = 1.0f;
        ...
        public void Update()
        {
            ...
            foreach (ORNPTrigger trigger in Triggers)
                trigger.TryTrigger();
            ...
            if (_InitialTrigger != null)
            {
                ...
                if (!ALSoundSource.isPlaying)
                {
                    ...
                    {
                        TriggersList = from ORNPVariableTrigger t in VariableTriggers
                                                where t.IsBellow
                                                select t as ORNPTrigger;
                        if (TriggersList.Count() == VariableTriggers.Count && _InitialTrigger.SoundCommand is ORNPSoundPlayCommand
                            && !(_InitialTrigger.SoundCommand is ORNPPlayOneShot && _InitialTrigger.Signaled))
                        {
                ...
                else
                {
                    TriggersList = from t in Triggers
                             where t.Signaled &&
                             (t.SoundCommand is ORNPStartLoop || t.SoundCommand is ORNPStartLoopRelease)
                             select t;
        ...
        /// <returns></returns>
        static float Interpolate(float x, Ornp.Formats.Msts.VolumeCurve Curve)
        {
            if (Curve.CurvePoints.Count() < 2)
                return Curve.CurvePoints[0].Y;

            Ornp.Formats.Msts.CurvePoint[] curvePoints = Curve.CurvePoints;
        ...
        /// <param name="car"></param>
        /// <returns></returns>
        private float ReadValue(Ornp.Formats.Msts.VolumeCurve.Controls control, MSTSWagon car)
        {
            switch (control)
            {
                case Ornp.Formats.Msts.VolumeCurve.Controls.DistanceControlled: return SoundSource.DistanceSquared;
                case Ornp.Formats.Msts.VolumeCurve.Controls.SpeedControlled: return car.AbsSpeedMpS;
                case Ornp.Formats.Msts.VolumeCurve.Controls.Variable1Controlled: return car.Variable1;
                case Ornp.Formats.Msts.VolumeCurve.Controls.Variable2Controlled: return car.Variable2;
                case Ornp.Formats.Msts.VolumeCurve.Controls.Variable3Controlled: return car.Variable3;
                case Ornp.Formats.Msts.VolumeCurve.Controls.BrakeCylControlled: return car.BrakeSystem.GetCylPressurePSI();
                case Ornp.Formats.Msts.VolumeCurve.Controls.CurveForceControlled: return car.CurveForceNFiltered;
                default: return 0;
            }
        }
        ...
        private void Sweep()
        {
            foreach (var trigger in Triggers)
                if (trigger.SoundCommand is ORNPSoundPlayCommand)
                    foreach (var name in (trigger.SoundCommand as ORNPSoundPlayCommand).Files)
...
/////////////////////////////////////////////////////////
    ...
    public class ORNPTrigger
    {
        ...
        /// </summary>
        public ORNPSoundCommand SoundCommand;
    ...
    /// </summary>
    public class ORNPDiscreteTrigger : ORNPTrigger, Ornp.Common.EventHandler
    {
        /// <summary>
        ...
        public ORNPDiscreteTrigger(SoundStream soundStream, Events.Source eventSound, Ornp.Formats.Msts.Discrete_Trigger smsData, UserSettings settings)
        {
            TriggerID = Events.From(settings.MSTSBINSound, eventSound, smsData.TriggerID);
            SoundCommand = ORNPSoundCommand.FromMSTS(smsData.SoundCommand, soundStream);
        ...
        public ORNPDiscreteTrigger(SoundStream soundStream, Event triggerID, ORNPSoundCommand soundCommand)
        {
            TriggerID = triggerID;
    ...
    /// </summary>
    public sealed class ORNPDistanceTravelledTrigger : ORNPTrigger
    {
        Ornp.Formats.Msts.Dist_Travelled_Trigger SMS;
        float triggerDistance;
        TrainCar car;
        SoundStream SoundStream;

        public ORNPDistanceTravelledTrigger(SoundStream soundStream, Ornp.Formats.Msts.Dist_Travelled_Trigger smsData)
        {
            SoundStream = soundStream;
            car = soundStream.SoundSource.Car;
            SMS = smsData;
            SoundCommand = ORNPSoundCommand.FromMSTS(SMS.SoundCommand, soundStream );
            Initialize();
        }
    ...
    /// </summary>
    public class ORNPInitialTrigger: ORNPTrigger
    {
        private SoundStream SoundStream;

        public ORNPInitialTrigger(SoundStream soundStream, Ornp.Formats.Msts.Initial_Trigger smsData)
        {
            SoundCommand = ORNPSoundCommand.FromMSTS(smsData.SoundCommand, soundStream);
            SoundStream = soundStream;
        }
        ...
        public ORNPInitialTrigger(SoundStream soundStream, string wavFileName)
        {
            SoundCommand = ORNPSoundCommand.Precompiled(wavFileName, soundStream);
            SoundStream = soundStream;
        }
    ...
    /// </summary>
    public sealed class ORNPRandomTrigger : ORNPTrigger
    {
        Simulator Simulator;
        Ornp.Formats.Msts.Random_Trigger SMS;
        double triggerAtSeconds;
        SoundStream SoundStream;

        public ORNPRandomTrigger(SoundStream soundStream, Ornp.Formats.Msts.Random_Trigger smsData)
        {
            SoundStream = soundStream;
            SMS = smsData;
    ...
    /// </summary>
    public sealed class ORNPVariableTrigger : ORNPTrigger
    {
        Ornp.Formats.Msts.Variable_Trigger SMS;
        MSTSWagon car;
        SoundStream SoundStream;
        ...
        public ORNPVariableTrigger(SoundStream soundStream, Ornp.Formats.Msts.Variable_Trigger smsData)
        {
            SMS = smsData;
        ...
        public override void  Initialize()
        {
            StartValue = SMS.Event == Ornp.Formats.Msts.Variable_Trigger.Events.Distance_Dec_Past ? float.MaxValue : 0;
        ...
        public override void TryTrigger( )
        {
            ...
            switch (SMS.Event)
            {
                case Ornp.Formats.Msts.Variable_Trigger.Events.Distance_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Speed_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable1_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable2_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable3_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.BrakeCyl_Dec_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.CurveForce_Dec_Past:
                    ...
                    break;
                case Ornp.Formats.Msts.Variable_Trigger.Events.Distance_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Speed_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable1_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable2_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.Variable3_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.BrakeCyl_Inc_Past:
                case Ornp.Formats.Msts.Variable_Trigger.Events.CurveForce_Inc_Past:
                    if (newValue > SMS.Threshold)
                    {
                        Signaled = true;
                        if (SMS.Threshold >= StartValue)
            ...
            if (triggered && Enabled)
            {
...
#if DEBUGSCR
                ORNPStartLoop sl = SoundCommand as ORTSStartLoop;
                if (sl != null)
                {
                ...
                ORNPStartLoopRelease slr = SoundCommand as ORTSStartLoopRelease;
                if (slr != null)
                {
                ...
                ORNPReleaseLoopRelease rlr = SoundCommand as ORTSReleaseLoopRelease;
                if (rlr != null)
                {
                ...
                ORNPReleaseLoopReleaseWithJump rlrwj = SoundCommand as ORTSReleaseLoopReleaseWithJump;
                if (rlrwj != null)
                {
...
/////////////////////////////////////////////////////////
    ...
    /// </summary>
    public class ORNPPlayOneShot : ORNPSoundPlayCommand
    {
        public ORNPPlayOneShot(SoundStream ortsStream, Ornp.Formats.Msts.SoundPlayCommand mstsSoundPlayCommand)
            : base(ortsStream, mstsSoundPlayCommand)
        {
        }
        // precompiled version for activity sounds
        public ORNPPlayOneShot(SoundStream ortsStream, string wavFileName)
        ...
        public override void Run()
        {
            ...
            if (p != "")
            {
                if (ORNPStream != null && ORNPStream.ALSoundSource != null)
                    ORNPStream.ALSoundSource.Queue(p, PlayMode.OneShot, ORNPStream.SoundSource.IsExternal, ORNPStream.RepeatedTrigger);
            }
        }
    } 
    ...
    /// </summary>
    public class ORNPStartLoop : ORNPSoundPlayCommand
    {
        public ORNPStartLoop( SoundStream ortsStream, Ornp.Formats.Msts.SoundPlayCommand mstsSoundPlayCommand )
            : base( ortsStream, mstsSoundPlayCommand )
        {
        }
        public override void  Run( )
        {
            ...
            {
                if (ORNPStream != null && ORNPStream.ALSoundSource != null)
                    ORNPStream.ALSoundSource.Queue(p, PlayMode.Loop, ORNPStream.SoundSource.IsExternal, false);
            }
        }
    } 
    ...
    /// </summary>
    public class ORNPReleaseLoopRelease : ORNPSoundCommand
    {
        public ORNPReleaseLoopRelease(SoundStream ortsStream)
            : base(ortsStream)
        {
        }
        ...
        {
            if (ORNPStream != null && ORNPStream.ALSoundSource != null)
                ORNPStream.ALSoundSource.Queue("", PlayMode.Release, ORNPStream.SoundSource.IsExternal, false);
        }
    }
    ...
    /// </summary>
    public class ORNPStartLoopRelease : ORNPSoundPlayCommand
    {
        public ORNPStartLoopRelease(SoundStream ortsStream, Ornp.Formats.Msts.PlayOneShot mstsStartLoopRelease)
        ...
        public override void Run()
        {
            ...
            {
                if (ORNPStream != null && ORNPStream.ALSoundSource != null)
                    ORNPStream.ALSoundSource.Queue(p, PlayMode.LoopRelease, ORNPStream.SoundSource.IsExternal, ORNPStream.IsReleasedWithJump);
            }
        }
    }
    ...
    /// </summary>
    public class ORNPReleaseLoopReleaseWithJump : ORNPSoundCommand
    {
        public ORNPReleaseLoopReleaseWithJump(SoundStream ortsStream)
            : base(ortsStream)
        {
        }
        ...
        {
            if (ORNPStream != null && ORNPStream.ALSoundSource != null)
                ORNPStream.ALSoundSource.Queue("", PlayMode.ReleaseWithJump, ORNPStream.SoundSource.IsExternal, true);
        }
    }
    ...
    /// </summary>
    public class ORNPDisableTrigger : ORNPSoundCommand
    {
        int TriggerIndex;  // index into the stream's trigger list 

        public ORNPDisableTrigger(SoundStream ortsStream, Ornp.Formats.Msts.DisableTrigger smsData )
            : base(ortsStream)
        {
        ...
        public override void Run()
        {
            if (TriggerIndex >= 0 && TriggerIndex < ORNPStream.Triggers.Count)
                ORNPStream.Triggers[TriggerIndex].Enabled = false;
        }
    }
    ...
    /// </summary>
    public class ORNPEnableTrigger : ORNPSoundCommand
    {
        int TriggerIndex;

        public ORNPEnableTrigger(SoundStream ortsStream, Ornp.Formats.Msts.DisableTrigger smsData)
            : base(ortsStream)
        {
            TriggerIndex = smsData.TriggerID - 1;
        }
        ...
        {
            if ( TriggerIndex >= 0 && TriggerIndex < ORNPStream.Triggers.Count)
                ORNPStream.Triggers[TriggerIndex].Enabled = true;
        }
    }
    ...
    /// </summary>
    public class ORNPSetStreamVolume : ORNPSoundCommand
    {
        float Volume;

        public ORNPSetStreamVolume(SoundStream ortsStream, Ornp.Formats.Msts.SetStreamVolume smsData)
            : base(ortsStream)
        {
    ...
    /// </summary>
    public class ORNPNoOp : ORNPSoundCommand
    {
        public ORNPNoOp()
            : base(null)
        {
    ...
    /// </summary>
    public abstract class ORNPSoundCommand
    {
        /// <summary>
        /// The Stream in .sms file it belongs to
        /// </summary>
        protected SoundStream ORNPStream;

        public ORNPSoundCommand(SoundStream ortsStream)
        {
            ORNPStream = ortsStream;
        }
        ...
        /// <returns></returns>
        public static ORNPSoundCommand FromMSTS(Ornp.Formats.Msts.SoundCommand mstsSoundCommand, SoundStream soundStream)
        {
            if (mstsSoundCommand == null)
            {
                return new ORNPNoOp();
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.PlayOneShot))
            {
                return new ORNPPlayOneShot(soundStream, (Ornp.Formats.Msts.PlayOneShot)mstsSoundCommand);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.StartLoop))
            {
                return new ORNPStartLoop(soundStream, (Ornp.Formats.Msts.StartLoop)mstsSoundCommand);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.StartLoopRelease))
            {
                return new ORNPStartLoopRelease(soundStream, (Ornp.Formats.Msts.StartLoopRelease)mstsSoundCommand);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.ReleaseLoopRelease))
            {
                return new ORNPReleaseLoopRelease(soundStream);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.ReleaseLoopReleaseWithJump))
            {
                return new ORNPReleaseLoopReleaseWithJump(soundStream);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.SetStreamVolume))
            {
                return new ORNPSetStreamVolume(soundStream, (Ornp.Formats.Msts.SetStreamVolume)mstsSoundCommand);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.DisableTrigger))
            {
                return new ORNPDisableTrigger(soundStream, (Ornp.Formats.Msts.DisableTrigger)mstsSoundCommand);
            }
            else if (mstsSoundCommand.GetType() == typeof(Ornp.Formats.Msts.EnableTrigger))
            {
                return new ORNPEnableTrigger(soundStream, (Ornp.Formats.Msts.EnableTrigger)mstsSoundCommand);
            }
        ...
        /// <param name="soundStream"></param>
        /// <returns></returns>
        public static ORNPSoundCommand Precompiled(string wavFileName, SoundStream soundStream)
        {
            return new ORNPPlayOneShot(soundStream, wavFileName);        
        }
    ...
    /// </summary>
    public abstract class ORNPSoundPlayCommand : ORNPSoundCommand
    {
        /// <summary>
        ...
        /// </summary>
        protected Ornp.Formats.Msts.SoundCommand.SelectionMethods SelectionMethod;
        /// <summary>
        /// Index of the file to play inside <see cref="Files"/> vector
        /// </summary>
        public int iFile;

        public ORNPSoundPlayCommand(SoundStream ortsStream, Ornp.Formats.Msts.SoundPlayCommand mstsSoundPlayCommand)
            : base(ortsStream)
        {
        ...
        // precompiled version for activity sounds
        public ORNPSoundPlayCommand(SoundStream ortsStream, string wavFileName)
            : base(ortsStream)
        {
            Files = new String[1];
            Files[0] = wavFileName;
            SelectionMethod = Ornp.Formats.Msts.SoundCommand.SelectionMethods.SequentialSelection;
        }
        ...
        {
            if (SelectionMethod == Ornp.Formats.Msts.SoundCommand.SelectionMethods.SequentialSelection)
            {
                ++iFile;
                if (iFile >= Files.Length)
                    iFile = 0;
            }
            else if (SelectionMethod == Ornp.Formats.Msts.SoundCommand.SelectionMethods.RandomSelection)
            {
            ...
            string[] pathArray = {ORNPStream.SoundSource.SMSFolder, 
                                     Program.Simulator.RoutePath + @"\SOUND", 
                                     Program.Simulator.BasePath + @"\SOUND"};
            var fullPath = ORNPPaths.GetFileFromFolders(pathArray, Files[iFile]);
    ...
    public class WorldSounds
    {
        ...
        public int GetTType(Train train, out float outPrevDist, out float outNextDist)
        {
            ...
            Ornp.Formats.Msts.TrackDB trackDB = Viewer.Simulator.TDB.TrackDB;
            Ornp.Formats.Msts.TrItem[] trItems = trackDB.TrItemTable;
            ...
            lock (SoundRegions)
            {
                ...
                foreach (List<WorldSoundRegion> lwsr in SoundRegions.Values)
                {
                    foreach (WorldSoundRegion wsr in lwsr)
                    {
                        ...
                        {
                            if (trItems[trNode].ItemType == Ornp.Formats.Msts.TrItem.trItemType.trSOUNDREGION)
                            {
        ...
        public void AddByTile(int TileX, int TileZ)
        {
            ...
            if (wf.TR_WorldSoundFile != null)
            {
                ...
                foreach (var fss in wf.TR_WorldSoundFile.SoundSources)
                {
                    ...
                    var fullPath = ORNPPaths.GetFileFromFolders(pathArray, @"Sound\" + fss.SoundSourceFileName);
                    if (fullPath != null)
                    {
    ...
    public class ORTSActSoundSources
    {
        ...
        public void Update()
        {
            if (Program.Simulator.ActivityRun == null || Program.Simulator.ActivityRun.triggeredEventWrapper == null || 
                (Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.ORNPActSoundFile == null && (Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes == null
            ...
            string ORNPActSoundFile;
            ORNPActSoundFileTypes ORNPActSoundFileType;
            ActivitySound activitySound = null;
            if (Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes == null
                || Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes.ActivitySound == null)
            {
                ORNPActSoundFile = Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.ORNPActSoundFile;
                ORNPActSoundFileType = Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.ORNPActSoundFileType;
            }
            else
            {
                activitySound = Program.Simulator.ActivityRun.triggeredEventWrapper.ParsedObject.Outcomes.ActivitySound;
                ORNPActSoundFile = activitySound.ORNPActSoundFile;
                ORNPActSoundFileType = activitySound.ORNPActSoundFileType;
            }
            ...
            var extension = Path.GetExtension(ORNPActSoundFile);
            SoundSource ActivitySounds;
            switch (extension)
            {
                case ".sms":
                    switch (ORNPActSoundFileType)
                    {
                        case ORNPActSoundFileTypes.Everywhere:
                            ActivitySounds = new SoundSource(Program.Viewer, Events.Source.MSTSInGame, ORNPActSoundFile, true);
                        ...
                        case ORNPActSoundFileTypes.Cab:
                            ...
                            ActivitySounds = new SoundSource(Program.Viewer, playerLoco, ORNPActSoundFile);
                            Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            break;
                        case ORNPActSoundFileTypes.Pass:
                            if (Program.Viewer.Camera.Style == Camera.Styles.Passenger && Program.Viewer.Camera.AttachedCar != null)
                            {
                                ...
                                ActivitySounds = new SoundSource(Program.Viewer, selectedWagon, ORNPActSoundFile);
                                Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            }
                            break;
                        case ORNPActSoundFileTypes.Ground:
                            ...
                            ActivitySounds = new SoundSource(Program.Viewer, worldLocation, Events.Source.None, ORNPActSoundFile, true);
                            Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            break;
                        case ORNPActSoundFileTypes.Location:
                            worldLocation = WorldLocation.None;
                ...
                case ".wav":
                    ...
                    {
                        case ORNPActSoundFileTypes.Everywhere:
                            ActivitySounds = new SoundSource(Program.Viewer, Events.Source.MSTSInGame, ORNPActSoundFile, ORNPActSoundFileType, true, true);
                            Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            break;
                        case ORNPActSoundFileTypes.Cab:
                            var playerLoco = (MSTSWagon)Program.Viewer.Simulator.PlayerLocomotive;
                            ActivitySounds = new SoundSource(Program.Viewer, playerLoco, ORNPActSoundFile, ORNPActSoundFileType, true);
                            Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            break;
                        case ORNPActSoundFileTypes.Pass:
                            if (Program.Viewer.Camera.Style == Camera.Styles.Passenger && Program.Viewer.Camera.AttachedCar != null)
                            {
                                var selectedWagon = (MSTSWagon)Program.Viewer.Camera.AttachedCar;
                                ActivitySounds = new SoundSource(Program.Viewer, selectedWagon, ORNPActSoundFile, ORNPActSoundFileType, true);
                                Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            }
                            break;
                        case ORNPActSoundFileTypes.Ground:
                            ...
                            var worldLocation = loco.WorldPosition.WorldLocation;
                            worldLocation.Location.Y = worldLocation.Location.Y + 3; // Sound does not come from earth!
                            ActivitySounds = new SoundSource(Program.Viewer, worldLocation, Events.Source.None, ORNPActSoundFile, true, ORNPActSoundFileType, true);
                            Program.Viewer.SoundProcess.AddSoundSources(localEventID, new List<SoundSourceBase>() { ActivitySounds });
                            break;
                        case ORNPActSoundFileTypes.Location:
                            worldLocation = WorldLocation.None;

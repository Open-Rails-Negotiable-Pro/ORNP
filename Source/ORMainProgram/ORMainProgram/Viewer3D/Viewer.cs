...
using Ornp.Viewer3D.RollingStock;
using ORNP.Common;
...
namespace Ornp.Viewer3D
{
    public class Viewer
    {
        ...
        // Components
        public Ornp.Viewer3D.Processes.Game Game { get; private set; }
        ...
        [CallOnThread("Loader")]
        public Viewer(Simulator simulator, Ornp.Viewer3D.Processes.Game game)
        {
            Catalog = new Catalog("RunActivity", "./locale");
            Random = new Random();
            Simulator = simulator;
            Game = game;
        ...
        internal void Initialize()
        {
            ...
            ViewerSounds = new SoundSource(this, soundSource => new[]
            {
                ...
                {
                    new ORNPDiscreteTrigger(soundStream, Event.TakeScreenshot, ORNPSoundCommand.Precompiled(Path.Combine(ContentPath, "TakeScreenshot.wav"), soundStream)),
                }),
            });

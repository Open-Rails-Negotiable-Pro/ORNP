    ...
    public class SignalShape : PoseableShape
    {
        ...
        class SignalShapeHead
        {
            ...
            public SignalShapeHead(Viewer viewer, SignalShape signalShape, int index, SignalHead signalHead,
                        Ornp.Formats.Msts.SignalItem mstsSignalItem, Ornp.Formats.Msts.SignalShape.SignalSubObj mstsSignalSubObj)
            {
                Viewer = viewer;
        ...
        class SignalTypeData
        {
            ...
            public SignalTypeData(Viewer viewer, Ornp.Formats.Msts.SignalType mstsSignalType)
            {
                ...
                else
                {
                    ...
                    foreach (KeyValuePair<string, Ornp.Formats.Msts.SignalDrawState> sdrawstate in mstsSignalType.DrawStates)
        ...
        class SignalAspectData
        {
            ...
            public SignalAspectData(Ornp.Formats.Msts.SignalType mstsSignalType, Ornp.Formats.Msts.SignalDrawState drawStateData)
            {
                if (mstsSignalType.Lights != null)
                {

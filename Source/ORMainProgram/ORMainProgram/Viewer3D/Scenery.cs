...
namespace Ornp.Viewer3D
{
    ...
    public class WorldFile
    {
        ...
        public WorldFile(Viewer viewer, int tileX, int tileZ, bool visible)
        {
            ...
            // read the world file 
            var WFile = new Ornp.Formats.Msts.WorldFile(WFilePath);
            ...
            if (Viewer.Settings.ModelInstancing && Viewer.Settings.IsDirectXFeatureLevelIncluded(ORNP.Settings.UserSettings.DirectXFeature.Level9_3))
            {

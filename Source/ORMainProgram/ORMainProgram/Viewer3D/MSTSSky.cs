...
namespace Ornp.Viewer3D
{
    ...
    public class MSTSSkyDrawer
    {
        ...
        public Ornp.Viewer3D.SkyViewer.Date date;
            ...
            : base(viewer, null)
        {
            ...
            if (viewer.ENVFile.SkyLayers != null)
            {
                ...
                for (int i = 0; i < Viewer.ENVFile.SkyLayers.Count; i++)
                {
                    ...
                    MSTSSkyTexture.Add(Ornp.Formats.Msts.AceFile.Texture2DFromFile(Viewer.RenderProcess.GraphicsDevice, mstsSkyTexture[i]));
                    if( i == 0 )
                    {
                    ...
                    {
                        MSTSSkyCloudTexture.Add(Ornp.Formats.Msts.AceFile.Texture2DFromFile(Viewer.RenderProcess.GraphicsDevice, mstsSkyTexture[i]));

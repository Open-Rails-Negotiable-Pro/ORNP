            ...
            foreach (Wagon wagon in conFile.Train.TrainCfg.WagonList)
            {
                ...
                try
                {
                    ...
                    if (isInitialPlayerTrain)
                    {
                        ...
                        {
                            mstsSteamLocomotive.CombinedTenderWaterVolumeUKG = (ORNP.Common.Kg.ToLb(mstsSteamLocomotive.MaxLocoTenderWaterMassKG) / 10.0f) * Simulator.Activity.Tr_Activity.Tr_Activity_Header.FuelWater / 100.0f;

...
using Ornp.Simulation.Signalling;
using ORNP.Common;
using System;
...
namespace Ornp.Simulation
{
    ...
    {
        public Ornp.Formats.Msts.Event ParsedObject;     // Points to object parsed from file *.act
        ...
        public EventWrapper(Ornp.Formats.Msts.Event @event, Simulator simulator)
        {
            ParsedObject = @event;
            Simulator = simulator;
            Train = null;
    ...
    public class EventCategoryActionWrapper : EventWrapper
    {
        ...
        public EventCategoryActionWrapper(Ornp.Formats.Msts.Event @event, Simulator simulator)
    ...
    {
        public EventCategoryLocationWrapper(Ornp.Formats.Msts.Event @event, Simulator simulator)
            : base(@event, simulator)
        {
        }
        ...
        {
            var triggered = false;
            var e = this.ParsedObject as Ornp.Formats.Msts.EventCategoryLocation;
            var train = Simulator.PlayerLocomotive.Train;
    ...
    public class EventCategoryTimeWrapper : EventWrapper
    {
        ...
        public EventCategoryTimeWrapper(Ornp.Formats.Msts.Event @event, Simulator simulator)
            : base(@event, simulator)
        {
        }
        ...
        override public Boolean Triggered(Activity activity)
        {
            var e = this.ParsedObject as Ornp.Formats.Msts.EventCategoryTime;

...
namespace Ornp.Simulation
{
    ...
    public class Simulator
    {
        ...
        {
            Catalog = new Catalog("Orts.Simulation", "./locale");
            Random = new Random();
        ...
        public void Restore(BinaryReader inf, string pathName, float initialTileX, float initialTileZ, CancellationToken cancellation)
        {
            ...
            ActivityRun = Ornp.Simulation.Activity.Restore(inf, this, ActivityRun);
        ...
        public void Save(BinaryWriter outf)
        {
            ...
            Ornp.Simulation.Activity.Save(outf, ActivityRun);
        }
        ...
        public void UncoupleBehind(TrainCar car, bool keepFront)
        {
            ...
            if (MPManager.IsMultiPlayer())
            {
                MPManager.Notify((new Ornp.MultiPlayer.MSGUncouple(train, train2, Ornp.MultiPlayer.MPManager.GetUserName(), car.CarID, PlayerLocomotive)).ToString());
            }

...
using Ornp.Simulation.RollingStocks.SubSystems;
...
namespace Ornp.Simulation.RollingStocks
{
    ...
    public abstract class TrainCar
    {
        ...
        public void InitializeCarTemperatures()
        {
            ...
            new Ornp.Common.WorldLatLon().ConvertWTC(WorldPosition.TileX, WorldPosition.TileZ, WorldPosition.Location, ref latitude, ref longitude);

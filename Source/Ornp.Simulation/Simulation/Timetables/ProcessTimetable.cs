...
namespace Ornp.Simulation.Timetables
{
    public class TimetableInfo
    {
        ...
        private class TTTrainInfo
        {
            ...
            public List<TrainCar> AddWagons(Ornp.Formats.Msts.ConsistFile consistFile, string trainsDirectory, Simulator simulator, bool consistReverse)
            {

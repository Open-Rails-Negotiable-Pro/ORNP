...
namespace Ornp.Common.Scripting
{
    [CallOnThread("Loader")]
    public class ScriptManager
    {
        ...
        static CompilerParameters GetCompilerParameters()
        {
            ...
            cp.ReferencedAssemblies.Add("ORNP.Common.dll");
            cp.ReferencedAssemblies.Add("Ornp.Simulation.dll");
            return cp;
        }
        ...
        public object Load(string[] pathArray, string name, string nameSpace = "ORNP.Scripting.Script")
        {
            ...
            var path = ORNPPaths.GetFileFromFolders(pathArray, name);

...
namespace Ornp.Formats.OR
{
    ...
    public class TimetableFileLite
    {
        ...
        public class TrainInformation : IComparable<TrainInformation>
        {
            ...
            ICatalog Catalog = new Catalog("Orts.Formats.OR", "./locale");
            ...
            public string[] ToInfo()
            {
                ...
                if (string.IsNullOrEmpty(Briefing))
                    return new[] { Catalog.GetString("Start time: {0}", StartTime) };
                else
                    return new[] { Catalog.GetString("Start time: {0}", StartTime), "", Briefing };
